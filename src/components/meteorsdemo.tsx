      ...
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="relative max-w-md mx-auto">
          ...
          <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-8 py-20 overflow-hidden rounded-2xl flex flex-col justify-end items-start">
            <h2 className="font-bold text-3xl text-white mb-4">Hola!, Soy Facundo</h2>

            <div>
              <h1 className="font-bold text-3xl text-white mb-10">
                Frontend Developer.
                <p className="font-normal text-lg text-slate-500 mt-6">
                  Desarrollador Frontend con experiencia en tecnologías como React y Next.js,
                  Apasionado por la innovación tecnológica y el desarrollo de soluciones que
                  impulsen el éxito empresarial. Actualmente trabajando en Grupo Cober,
                  desarrollando software a medida para prepagas medicinales.
                </p>
              </h1>
              <button
